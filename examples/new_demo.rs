...
use bevy_mod_adwaita::{AdwaitaPlugin, AdwaitaRenderTarget};
    ...
    commands.spawn((
        Camera3dBundle {
            camera: Camera {
                ...
                order: -1,
                target: r_tgt.0.clone().into(), //image_handle.clone().into(),
